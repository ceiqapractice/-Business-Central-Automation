...
const { LoginPage } = require("../../main/web/npx playwright test test/web/CustomerHomologationtest.spec.js --debugg/LoginPage");
...
test("Test 1 -> @Create", async ({page})=>
  {
    ...
    await topframe.locator("//button[normalize-space()='Vendors']").click();
    // await topframe.locator("//button[normalize-space()='New']").click();
    await topframe.locator("//div[normalize-space()='Search']").click();    
